...
class BoxXZ extends Box{
    ...
    public void render(final BufferBuilder buffer, final TextureAtlasSprite sprite, final ColorBox colorBox) {
        ...
        this.renderInternal(buffer, sprite, 0.0D, 0.5D, 0.0D, -this.dz / n2Size / (double)2, this.dx / n2Size / (double)2, colorBox.alpha, colorBox.red, colorBox.green, colorBox.blue);
    }
